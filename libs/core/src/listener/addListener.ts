 ...
 * @returns cancelToken
 */
function once<T extends keyof T2E, E = T2E[T]>(type: T, listenerFn: Listener<E>): string;
 ...
 * @returns cancelToken
 */
function repeated<T extends keyof T2E, E = T2E[T]>(type: T, listenerFn: Listener<E>): string;
...
function keydownLong(key: Key, options: Options, listenerFn: Listener<KeyboardEvent>): string;
